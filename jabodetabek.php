...
<body>
      ...
      if ($result) {
        while ($row = $result->fetch_assoc()) {
          ...
          ?>
            ...
            <td>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-info" data-bs-toggle="modal"
                        data-bs-target="#<?php echo $backupId; ?>">Backup
                        Server</button>
            ...
            <div class="modal fade" id="deleteModal<?php echo $row['id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="hapus_data_jabodetabek.php" method="POST">
                    <div class="card-body">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-danger btn-confirm-delete">Hapus</button>
                </form> <!-- Move form closing tag here -->
            </div>
        </div>
    </div>
</div>
